#### Model calculations optimised + using Rcpp ####

f_model_e  <- function(params) {
  # Rcpp::sourceCpp("f_propagate_states.cpp") # for parLapply() and future_sapply() Rcpp functions are not automatically exported to parallel workers
