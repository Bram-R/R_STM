#### Model calculations by ChatGPT using Rccp ####

f_model_test_rcpp <- function(params) {
  ...
  # Use the Rcpp function for state propagation
  state_matrix_cp <- f_propagate_states(P_cp, n_t)
  state_matrix_nt <- f_propagate_states(P_nt, n_t)
